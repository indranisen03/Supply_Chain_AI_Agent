...
A multi-agent supply chain AI procurement recommendation system with tiered HITL oversight, an independent LLM judge, RAG-grounded policy compliance, and a full SOC2 audit trail
